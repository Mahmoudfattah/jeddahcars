...
const otherSites = [
  {
    label: "ba3hacash.com",
    href: "https://ba3hacash.com/",
  },
  {
    label: "ahmed-alhawary.com",
...
export default function Footer() {
  return (
    <footer
      id="contact"
      dir="rtl"
      className="relative overflow-hidden bg-[#090e17] pt-8 sm:pt-12 border-t border-white/5"
    >
      ...
      <div className="container-custom relative z-10 px-4 sm:px-6 max-w-7xl mx-auto">
        {/* Top CTA Card */}
        <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-[#162438] to-[#0f172a] border border-white/10 p-6 sm:p-10 lg:p-12 mb-16 shadow-[0_0_40px_rgba(56,189,248,0.05)]">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-right">
            ...
            <div className="w-full md:flex-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[#38bdf8] text-xs font-bold mb-3">
              ...
              <p className="text-slate-400 mt-1 text-sm sm:text-base max-w-md mx-auto md:mx-0 leading-relaxed">
                أرسل صور سيارتك الآن عبر الواتساب واحصل على أفضل تسعيرة وتقييم
                فوري خلال دقائق.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto shrink-0">
              ...
              <a
                href={`tel:${PHONE_TEL}`}
                dir="rtl"
                className="group flex items-center justify-center gap-3 w-full sm:w-auto min-w-[175px] h-14 px-5 rounded-full border border-white/10 bg-white/5 text-white hover:bg-white/10 hover:border-[#38bdf8]/40 transition-all duration-300"
                aria-label={`اتصل بنا على ${PHONE_DISPLAY}`}
              >
                <div className="w-9 h-9 rounded-full bg-[#38bdf8]/10 text-[#38bdf8] flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shrink-0">
                  <Phone size={19} />
                </div>
              ...
              <a
                ...
                dir="rtl"
                className="group flex items-center justify-center gap-3 w-full sm:w-auto min-w-[190px] h-14 px-5 rounded-full bg-[#25D366] text-white font-bold shadow-[0_0_20px_rgba(37,211,102,0.18)] hover:shadow-[0_0_30px_rgba(37,211,102,0.35)] hover:-translate-y-1 transition-all duration-300"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 pb-12">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              نشتري سيارتك المصدومة أو التالفة أو التشليح في جميع أنحاء المملكة
              (جدة، مكة، الطائف) بأفضل الأسعار مع توفير خدمة السحب مجاناً
              وإنهاء الإجراءات بضغطة زر.
            </p>
            ...
            <div className="flex flex-col gap-3 mt-2">
              ...
              <a
                href={`tel:${PHONE_TEL}`}
                dir="ltr"
                className="group flex items-center justify-end gap-3 w-fit px-4 py-2 rounded-xl bg-white/5 border border-white/5 hover:border-[#38bdf8]/30 hover:bg-[#162438] transition-all"
              >
                <span className="text-slate-300 font-medium tracking-wider group-hover:text-white transition-colors">
                  {PHONE_DISPLAY}
                </span>
              ...
              <a
                ...
                rel="noopener noreferrer"
                dir="ltr"
                className="group flex items-center justify-end gap-3 w-fit px-4 py-2 rounded-xl bg-white/5 border border-white/5 hover:border-[#25D366]/30 hover:bg-[#25D366]/5 transition-all"
              >
                <span className="text-slate-300 font-medium tracking-wider group-hover:text-white transition-colors">
                  {PHONE_DISPLAY}
                </span>
            ...
            <ul className="flex flex-col gap-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="group flex items-center gap-2 text-sm text-slate-400 hover:text-[#38bdf8] transition-colors w-fit"
                  >
            ...
            <div className="flex flex-wrap gap-2">
              {otherSites.map((site) => (
                ...
                >
                  <ExternalLink
                    size={14}
                    className="text-slate-500 group-hover:text-[#38bdf8] transition-colors"
                  />
